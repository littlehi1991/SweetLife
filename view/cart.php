    ...
    <body class="container">
        <div class="card" style="width: 100%;">
            <div style="float: left;">
                <img src="img/S__52101127.jpg" class="card-img-top" alt="..."style="width: 20%;float: left;">
            </div>
            <div style="float: right;">
                    <h5 class="card-title">購買的專案名稱</h5></span>
                    <p class="card-text">隨便介紹一下</p>
                    <div class="card-body">
